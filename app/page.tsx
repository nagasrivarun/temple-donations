...
export default function Page() {
  return (
    <div className="min-h-screen">
      ...
      <StorySection
        title="తాటిపల్లి హనుమాన్ మందిరం నిర్మాణం"
        description={[
          "తాటిపల్లి గ్రామంలో తాటిపల్లి హనుమాన్ మందిరం నిర్మాణం ఒక పవిత్ర ఆరంభం.",
        ...
        imageAlt="తాటిపల్లి హనుమాన్ మందిరం"
        imagePosition="right"
      />
      ...
      <StorySection
        ...
        description={[
          "తాటిపల్లి హనుమాన్ మందిరం గ్రామ ప్రజల విశ్వాసానికి ప్రతీకగా నిలవబోతోంది.",
      ...
      <StorySection
        ...
        description={[
          "ఈ తాటిపల్లి హనుమాన్ మందిరం భవిష్యత్ తరాలకు మన సంప్రదాయాలు మరియు భక్తిని అందించే కేంద్రంగా మారనుంది.",
          "తాటిపల్లి గ్రామంలో నిర్మాణం జరుగుతున్న ఈ ఆలయానికి మీ సహకారం అత్యంత విలువైనది.",
        ...
        <div className="max-w-6xl mx-auto">
          <AnimatedSection>
            ...
            <p className="text-center text-muted-foreground mb-12 text-pretty">
              తాటిపల్లి హనుమాన్ మందిరం నిర్మాణానికి మీ విరాళం అందించి, ఈ పవిత్ర కార్యంలో భాగస్వాములు అవ్వండి
            </p>
          </AnimatedSection>
          <DonationTiers />
        </div>
      ...
      <AnimatedSection direction="up">
        <footer className="py-12 px-6 border-t">
          <div className="max-w-6xl mx-auto text-center space-y-4">
            <p className="text-lg font-semibold">తాటిపల్లి హనుమాన్ మందిరం నిర్మాణ నిధి</p>
            <p className="text-sm text-muted-foreground">తాటిపల్లి గ్రామం, భారతదేశం</p>
            <p className="text-xs text-muted-foreground">© 2025 తాటిపల్లి హనుమాన్ మందిరం. అన్ని హక్కులు రిజర్వ్.</p>
          </div>
        </footer>
      </AnimatedSection>
    </div>
